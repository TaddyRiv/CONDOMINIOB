    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('punto_acceso', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='intentos', to='app.puntoacceso')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('aws_face_id', models.CharField(blank=True, max_length=200, null=True)),
        ...
        migrations.AddField(
            model_name='intentoacceso',
            name='vehiculo',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='intentos_acceso', to='app.vehiculo'),
        ),
        migrations.CreateModel(
            name='Visita',
            fields=[
